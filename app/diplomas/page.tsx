    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div
                ...
                style={{ background: "rgba(92,122,91,0.08)", borderLeft: "3px solid var(--sage)" }}
              >
                <p className="font-sans text-xs uppercase tracking-wider mb-1" style={{ color: "var(--sage)" }}>
                  Opção mais rápida
                </p>
                <p className="font-display text-lg leading-snug mb-2" style={{ color: "var(--ink-900)" }}>
              ...
              <div
                className="p-4 rounded"
                style={{ background: "rgba(200,128,26,0.08)", borderLeft: "3px solid var(--amber-accent)" }}
              >
                <p className="font-sans text-xs uppercase tracking-wider mb-1" style={{ color: "var(--amber-deep)" }}>
                  Mais detalhado
                </p>
                <p className="font-display text-lg leading-snug mb-2" style={{ color: "var(--ink-900)" }}>
        ...
        <div className="grid gap-5" style={{ gridTemplateColumns: "44px 1fr" }}>
          ...
          <div>
              ...
              <li className="flex gap-3 items-start">
                ...
                <div>
                  <p className="font-sans text-base" style={{ color: "var(--ink-900)" }}>
                    ...
                    <span className="italic" style={{ color: "var(--ink-600)" }}>
                      {" "}— apenas para reconhecimento específico
                    </span>
                  </p>
                </div>
              </li>
            ...
            <div
              ...
              style={{ background: "rgba(200,128,26,0.1)", borderLeft: "3px solid var(--amber-accent)" }}
            >
              <p className="font-sans text-xs uppercase tracking-wider mb-2" style={{ color: "var(--amber-deep)" }}>
                ⚠️ Crítico
              </p>
      ...
      <section className="mb-10">
        <div
          ...
          style={{ background: "rgba(200,128,26,0.06)", borderLeft: "3px solid var(--amber-deep)" }}
        >
          <p className="font-sans text-xs uppercase tracking-[0.2em] mb-2" style={{ color: "var(--amber-deep)" }}>
            Resumo prático
          </p>
      ...
      <section className="mb-10">
        <div className="pt-6 border-t" style={{ borderColor: "var(--ink-200)" }}>
          <p className="font-sans text-xs uppercase tracking-[0.2em] mb-3" style={{ color: "var(--ink-400)" }}>
            Link oficial
          </p>
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-3 font-sans text-sm hover:opacity-90 transition"
            style={{ background: "var(--ink-900)", color: "var(--paper)" }}
          >
            Iniciar processo na DGES ↗
          </a>
          <p className="font-sans text-xs italic mt-3" style={{ color: "var(--ink-400)" }}>
            dges.gov.pt/pt/pagina/reconhecimento
          </p>
        </div>
      </section>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link
              ...
              className="px-5 py-3 font-sans text-sm border hover:bg-white/40 transition"
            ...
            <Link
              ...
              className="px-5 py-3 font-sans text-sm hover:opacity-90 transition"
              style={{ background: "var(--ink-900)", color: "var(--paper)" }}
            >
